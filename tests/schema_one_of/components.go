...
var _ json.Marshaler = (*Dog_Schema)(nil)
...
func (c Dog_Schema) marshalJSONInnerBody(out io.Writer) error {
	encoder := json.NewEncoder(out)
	var err error
	var comma string
	write := func(s string) {
...
var _ json.Unmarshaler = (*Dog_Schema)(nil)
...
func (c *Dog_Schema) unmarshalJSONInnerBody(m map[string]json.RawMessage) error {
	var err error
	_ = err
	if raw, ok := m["name"]; ok {
		err = json.Unmarshal(raw, &c.Name)
...
var _ json.Marshaler = (*Dog2_Schema)(nil)
...
func (c Dog2_Schema) marshalJSONInnerBody(out io.Writer) error {
	encoder := json.NewEncoder(out)
	var err error
	var comma string
	write := func(s string) {
...
var _ json.Unmarshaler = (*Dog2_Schema)(nil)
...
func (c *Dog2_Schema) unmarshalJSONInnerBody(m map[string]json.RawMessage) error {
	var err error
	_ = err
	if raw, ok := m["name"]; ok {
		err = json.Unmarshal(raw, &c.Name.Value)
